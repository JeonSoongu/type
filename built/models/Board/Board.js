            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (boards) {
                            return [2 /*return*/, { success: true, msg: "게시판 조회 성공", boards: boards }];
                        }
                        return [3 /*break*/, 4];
                    case 3:
                        err_2 = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_7 = _a.sent();
                        return [2 /*return*/, Error_1.default.ctrl("서버 에러입니다. 서버 개발자에게 문의해주세요.", err_7)];
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_8 = _a.sent();
                        return [2 /*return*/, Error_1.default.ctrl("서버 에러입니다. 서버 개발자에게 문의해주세요.", err_8)];
                    case 4: return [2 /*return*/];
                }
            });
        });
