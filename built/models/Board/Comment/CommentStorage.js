...
var CommentStorage = /** @class */ (function () {
    ...
    CommentStorage.createByBoardNum = function (comment, boardNum) {
        return new Promise(function (resolve, reject) {
            ...
            db_1.default.query(query, [comment.studentId, boardNum, comment.content, comment.depth], function (err, createdInfo) {
                if (err)
                    reject(err);
    ...
    CommentStorage.createReplyByGroupNum = function (reply, boardNum, groupNum) {
        return new Promise(function (resolve, rejcet) {
            ...
            db_1.default.query(query, [reply.studentId, boardNum, reply.content, groupNum], function (err, replyInfo) {
                if (err)
                    rejcet(err);
    ...
    CommentStorage.findAllByBoardNum = function (boardNum) {
        return new Promise(function (resolve, reject) {
            ...
            db_1.default.query(query, [boardNum], function (err, comment) {
                if (err)
                    reject(err);
                resolve(comment);
            });
    ...
    CommentStorage.findOneByNum = function (num) {
        return new Promise(function (resolve, reject) {
            ...
            db_1.default.query(query, [num], function (err, comments) {
                if (err)
                    reject(err);
                resolve(comments);
            });
    ...
    CommentStorage.findReplyFlag = function (num) {
        return new Promise(function (resolve, reject) {
            ...
            db_1.default.query(query, [num], function (err, replyFlag) {
                if (err)
                    reject(err);
                else
    ...
    CommentStorage.findOneGroupNum = function (num) {
        return new Promise(function (resolve, reject) {
            ...
            db_1.default.query(query, [num], function (err, comment) {
                if (err)
                    reject(err);
                else
    ...
    CommentStorage.updateReplyFlagOfCommentByGroupNum = function (commentNum) {
        return new Promise(function (resolve, reject) {
            ...
            db_1.default.query(query, [commentNum], function (err) {
                if (err)
                    reject(err);
                resolve(true);
            });
    ...
    CommentStorage.updateGroupNum = function (commentNum) {
        return new Promise(function (resolve, reject) {
            ...
            db_1.default.query(query, [commentNum, commentNum], function (err) {
                if (err)
                    reject(err);
                else
                    resolve(true);
    ...
    CommentStorage.updateByNum = function (comment, num) {
        return new Promise(function (resolve, reject) {
            ...
            db_1.default.query(query, [comment.content, num, comment.studentId], function (err, updatedInfo) {
                if (err)
                    reject(err);
                else
    ...
    CommentStorage.updatehiddenFlag = function (num) {
        return new Promise(function (resolve, reject) {
            ...
            db_1.default.query(query, [num], function (err) {
                if (err)
                    reject(err);
                else
                    resolve(true);
    ...
    CommentStorage.updateReplyFlag = function (groupNum) {
        return new Promise(function (resolve, reject) {
            ...
            db_1.default.query(query, [groupNum, groupNum], function (err, rows) {
                if (err)
                    reject(err);
                else
    ...
    CommentStorage.deleteCommentByNum = function (num) {
        return new Promise(function (resolve, rejcet) {
            ...
            db_1.default.query(query, [num], function (err, row) {
                if (err)
                    rejcet(err);
                else
    ...
    CommentStorage.deleteReplyByNum = function (num, studentId) {
        return new Promise(function (resolve, reject) {
            ...
            db_1.default.query(query, [num, studentId], function (err, row) {
                if (err)
                    reject(err);
                else
                    resolve(row.affectedRows);
    ...
    CommentStorage.findStudentIdByNum = function (boardNum) {
        return new Promise(function (resolve, reject) {
            var sql = "SELECT DISTINCT nickname \n      FROM comments cm\n      JOIN students st\n      ON st.id = cm.student_id\n      WHERE board_no = ? AND cm.hidden_flag = 0;";
            db_1.default.query(sql, boardNum, function (err, buyers) {
                if (err)
                    reject(err);
                else
                    resolve(buyers);
...
exports.default = CommentStorage;
